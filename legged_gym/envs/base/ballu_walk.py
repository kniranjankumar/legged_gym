...
class WalkingBallu(LeggedRobot):
    def __init__(self,*args,**kwargs):
        super(WalkingBallu, self).__init__(*args,**kwargs)
    ...
    def compute_observations(self):
        ...
        self.obs_buf = torch.rand_like(torch.cat(obs_list, dim=-1))
        print(self.obs_buf)
        # print(self.projected_gravity[0,:])
        if self.add_noise and False:
